...
# Of cause "http://github.com/Licenser/EPIC":EPIC uses clj-sandbox to run user scripts
# defn's "http://github.com/defn/walton":walton tool uses clj-sandbox to get better answers for your questions.
# Raynes's IRC-bot "http://github.com/Raynes/sexpbot":sexpbot uses clj-sandbox too let users evaluate and test code in the IRC.
